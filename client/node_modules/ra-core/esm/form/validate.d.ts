...
export declare type Validator = (value: any, values: any, props: any) => ValidationErrorMessage | null | undefined;
export declare const composeValidators: (...validators: any[]) => (value: any, values: any, meta: any) => Promise<any>;
export declare const composeSyncValidators: (...validators: any[]) => (value: any, values: any, meta: any) => any;
/**
 * Required validator
 *
