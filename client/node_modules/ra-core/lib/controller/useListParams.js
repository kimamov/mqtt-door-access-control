...
var useListParams = function (_a) {
    ...
    var filterValues = react_1.useMemo(function () { return (__assign(__assign({}, (query.filter || emptyObject)), filter)); }, [filter, query.filter]);
    ...
    var showFilter = react_1.useCallback(function (filterName, defaultValue) {
        ...
        var filter = set_1.default(filterValues, filterName, defaultValue);
        changeParams({
            type: queryReducer_1.SET_FILTER,
            payload: {
                filter: filter,
