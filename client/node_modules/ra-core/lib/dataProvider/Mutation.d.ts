...
interface Props {
    children: (mutate: (event?: any, callTimePayload?: any, callTimeOptions?: any) => void, params: ChildrenFuncParams) => JSX.Element;
    type: string;
    resource?: string;
    payload?: any;
    options?: any;
 ...
 * );
 */
declare const Mutation: FunctionComponent<Props>;
