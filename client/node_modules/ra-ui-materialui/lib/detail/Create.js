...
exports.Create = function (props) {
    ...
    var controllerProps = ra_core_1.useCreateController(props);
    return (React.createElement(ra_core_1.CreateContextProvider, { value: controllerProps },
        React.createElement(CreateView_1.CreateView, __assign({}, props, controllerProps))));
};
