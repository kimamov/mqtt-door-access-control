 ...
 * </ReferenceArrayInput>
 */
declare const ReferenceArrayInput: FC<ReferenceArrayInputProps>;
...
export declare const ReferenceArrayInputView: {
    ({ allowEmpty, basePath, children, choices, className, error, input, loading, isRequired, label, meta, onChange, options, reference, resource, setFilter, setPagination, setSort, source, translate, warning, ...rest }: ReferenceArrayInputViewProps): JSX.Element;
    propTypes: {
