...
exports.ReferenceArrayInputView = function (_a) {
    ...
    var translatedLabel = translate.apply(void 0, ra_core_1.getFieldLabelTranslationArgs({
        label: label,
        resource: resource,
        source: source,
    }));
    ...
    return (React.createElement(ra_core_1.ResourceContextProvider, { value: reference }, React.cloneElement(children, __assign(__assign({ allowEmpty: allowEmpty,
        basePath: basePath,
        choices: choices,
        className: className,
        error: error,
