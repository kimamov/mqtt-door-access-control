...
var TextInput = function (_a) {
    ...
    return (React.createElement(ResettableTextField_1.default, __assign({ id: id }, input, { label: label !== '' &&
            label !== false && (React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired })), error: !!(touched && error), helperText: React.createElement(InputHelperText_1.default, { touched: touched, error: error, helperText: helperText }) }, options, sanitizeInputRestProps_1.default(rest))));
};
TextInput.propTypes = {
